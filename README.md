...
```
git clone --recursive https://github.com/Realtime-Rendering-II/Lab_4.git
```  
...
![Cmake](https://www.uni-weimar.de/~bexo5814/rrII/images/CMake-0.png) 
  ...
  select the source (C:\\..\Lab_4) and build folder (C:\\..\Lab_4\build)    
...
![Cmake](https://www.uni-weimar.de/~bexo5814/rrII/images/first_start_culling.png)
  
Culling deactivated:  
![Cmake](https://www.uni-weimar.de/~bexo5814/rrII/images/culling_deactive.png)  

Culling activated:  
![Cmake](https://www.uni-weimar.de/~bexo5814/rrII/images/culling_active.png)  
